        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setConfig({ ...config, characterType: e.target.value as AvatarConfig['characterType'] })}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <select
                ...
                onChange={(e) => setConfig({ ...config, glasses: e.target.value as AvatarConfig['glasses'] })}
                className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-600"
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setConfig({ ...config, headwear: e.target.value as AvatarConfig['headwear'] })}
                className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-600"
              >
                <option value="none">None</option>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setConfig({ ...config, clothing: e.target.value as AvatarConfig['clothing'] })}
                className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-600"
              >
          ...
          <div>
            ...
            <div className="grid grid-cols-5 gap-2">
              {[
                ...
                <button
                  key={p.value}
                  onClick={() => setConfig({ ...config, personality: p.value as AvatarConfig['personality'] })}
                  className={`p-4 rounded-lg border-2 transition-all ${
